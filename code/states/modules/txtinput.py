...
Modified for use with the observer algorithm and changed syntax for consistency
...
class TextInputManager:
    ...
    def __init__(self,
        ...
        Args:
            ...
            validator: A function string -> bool defining valid input.
        """
    ...
    def value(self):
        """
        Get/set the value currently inputted.
        Doesn't change cursor position if possible.

        Returns: The string currently entered.
        """
    ...
    def cursor_pos(self):
        ...
        Will clamp to [0, length of input].
    ...
    def update(self, event: pygame.event.Event):
        """
        Update the interal state with a fresh pygame event.
...
class TextInputVisualizer:
    """
    Utility class to quickly visualize textual input,
    like a message or username.
    ...
    def __init__(self,
        ...
        """
        Args:
            manager: The TextInputManager used to manage the user input
            font_object: a pygame.font.Font object used for rendering
        ...
        self._font_object = pygame.font.Font(
            pygame.font.get_default_font(), 25) \
            if font_object is None else font_object
        ...
        self._surface = pygame.Surface((self._cursor_width,
                                        self._font_object.get_height()))
        self._rerender_required = True

    @property
    def value(self):
        """
        Get/set the value of text alreay inputted.
        Doesn't change cursor position if possible.
        """
    ...
    def cursor_visible(self):
        ...
        (flips again after `.cursor_interval` if continuously update)
        """
    ...
    def cursor_blink_interval(self):
        """
        Get/set the interval of time with which
        the cursor blinks (toggles), in ms
        """
    ...
    def _require_rerender(self):
        """
        Trigger a re-render of the surface the
        next time the surface is accessed.
        """
        self._rerender_required = True

    def _rerender(self):
        """ Rerender self._surface."""
        # Final surface is slightly larger than font_render itself,
        # to accomodate for cursor
        ...
        if self._cursor_visible:
            ...
            cursor_rect = pygame.Rect(cursor_y, 0, self._cursor_width,
                                      self.font_object.get_height())
