...
class Title(State):
    def __init__(self, game: 'Game'):
        ...
        # buttons
        self.btn_play = Btn(self.game, 64, self.game.WINX / 2, self.game.WINY / 2, 300, 75, 'Play', self.play)
        self.btn_options = Btn(self.game, 64, self.game.WINX / 2, self.btn_play.rect.bottom * 1.02, 300, 75, 'Options', self.options, btn_ref='midtop')
        self.btn_quit = Btn(self.game, 64, self.game.WINX / 2, self.btn_options.rect.bottom * 1.02, 300, 75, 'Quit', self.quit, btn_ref='midtop')

        # text
        self.ver_txt = Txt(self.game.font_dir, 32, self.game.WINX, self.game.WINY, self.game.game_ver,
                           ref='bottomright')

        self.objects = [self.logo_img, self.ver_txt, self.btn_play, self.btn_options, self.btn_quit]
    ...
    def on_enter(self) -> None:
        ...
        for i in [self.btn_options, self.btn_play, self.btn_quit]:
