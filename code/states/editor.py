    ...
    def __init__(self, game):
        ...
        self.btn_exit = BtnTxt(self.game, 36, self.game.WINX - 10, 10, 205, 50, 'Exit',
                               func=lambda: self.switch_state(Popup,
                                                              ...
                                                              'Confirm Exit',
                                                              'Back',
                                                              lambda: self.switch_state(EditorHome)),
                               btn_ref='topright')
...
#
#         self.a = [Enemy(self, self.rect_surf_rect.centerx * 0.5, self.txt_enemies.rects[0].bottom + 10, {'hp': 2, 'df': 0, 'atk': 4},
#         os.path.join(self.game.sfx_dir, 'shoot.wav'), ref='topleft', img_dir=os.path.join(self.game.enemy_dir, x)) for i, x in enumerate(self.enemy_list)]
