...
from src.components.ui import (TextArray, TextArrayConfig,
...
class OptionsOverlay(Overlay):
    def __init__(self):
        ...
        self.text_pos = (statemanager.current_state().bg_rect.left
...
class GeneralOptions(OptionsOverlay):
    def __init__(self):
        ...
        config_ = TextArrayConfig(
            (("Keep absolute position on fullscreen toggle:",),), wrap_width=500)
        self.text_row1 = TextArray(self.text_pos, (1, 1),
                                   statemanager.current_state().padding * 1.5,
                                   config_)
...
class GraphicsOptions(OptionsOverlay):
    def __init__(self):
        super().__init__()
        config_ = TextArrayConfig((("Fullscreen:", "Borderless:",
                                    "Resolution:"),))
        self.text_row1 = TextArray(self.text_pos, (3, 1),
                                   statemanager.current_state().padding * 1.5,
                                   config_)
